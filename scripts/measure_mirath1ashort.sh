...
export TIMING_RESULTS_DIR=results/mirath1ashort_times
export MEMORY_RESULTS_DIR=results/mirath1ashort_memory
export GENERATED_DIR=results/mirath1ashort_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm mirathtcith1ashort -out $GENERATED_DIR/private.key"
