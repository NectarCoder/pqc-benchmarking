...
(time ./openssl genpkey -provider default -provider oqsprovider -algorithm p521_mldsa87 -out $GENERATED_DIR/private.key) 2>> $RESULTS_DIR/time_private.txt
...
echo "NIST_Security_Level, 5" >> $RESULTS_DIR/nist_level.txt
