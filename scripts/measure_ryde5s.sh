...
export TIMING_RESULTS_DIR=results/ryde5s_times
export MEMORY_RESULTS_DIR=results/ryde5s_memory
export GENERATED_DIR=results/ryde5s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm ryde5s -out $GENERATED_DIR/private.key"
