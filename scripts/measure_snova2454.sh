...
export TIMING_RESULTS_DIR=results/snova2454_times
export MEMORY_RESULTS_DIR=results/snova2454_memory
export GENERATED_DIR=results/snova2454_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm snova2454 -out $GENERATED_DIR/private.key"
