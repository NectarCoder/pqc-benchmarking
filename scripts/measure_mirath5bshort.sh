...
export TIMING_RESULTS_DIR=results/mirath5bshort_times
export MEMORY_RESULTS_DIR=results/mirath5bshort_memory
export GENERATED_DIR=results/mirath5bshort_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm mirathtcith5bshort -out $GENERATED_DIR/private.key"
