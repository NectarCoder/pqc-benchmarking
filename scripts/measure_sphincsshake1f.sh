...
export TIMING_RESULTS_DIR=results/sphincsshake1f_times
export MEMORY_RESULTS_DIR=results/sphincsshake1f_memory
export GENERATED_DIR=results/sphincsshake1f_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL
export GEN_CMD="./openssl genpkey -algorithm slh-dsa-shake-128f -out $GENERATED_DIR/private.key"
