...
export TIMING_RESULTS_DIR=results/sphincsshake5f_times
export MEMORY_RESULTS_DIR=results/sphincsshake5f_memory
export GENERATED_DIR=results/sphincsshake5f_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL
export GEN_CMD="./openssl genpkey -algorithm slh-dsa-shake-256f -out $GENERATED_DIR/private.key"
