...
export TIMING_RESULTS_DIR=results/less252192_times
export MEMORY_RESULTS_DIR=results/less252192_memory
export GENERATED_DIR=results/less252192_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm less252192 -out $GENERATED_DIR/private.key"
