...
export TIMING_RESULTS_DIR=results/ryde1f_times
export MEMORY_RESULTS_DIR=results/ryde1f_memory
export GENERATED_DIR=results/ryde1f_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm ryde1f -out $GENERATED_DIR/private.key"
