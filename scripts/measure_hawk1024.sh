...
export TIMING_RESULTS_DIR=results/hawk1024_times
export MEMORY_RESULTS_DIR=results/hawk1024_memory
export GENERATED_DIR=results/hawk1024_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm hawk1024 -out $GENERATED_DIR/private.key"
