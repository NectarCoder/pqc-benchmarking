...
export TIMING_RESULTS_DIR=results/qruov5q31L10v1120m120_times
export MEMORY_RESULTS_DIR=results/qruov5q31L10v1120m120_memory
export GENERATED_DIR=results/qruov5q31L10v1120m120_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov5q31L10v1120m120 -out $GENERATED_DIR/private.key"
