...
export TIMING_RESULTS_DIR=results/qruov3q7L10v1100m140_times
export MEMORY_RESULTS_DIR=results/qruov3q7L10v1100m140_memory
export GENERATED_DIR=results/qruov3q7L10v1100m140_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov3q7L10v1100m140 -out $GENERATED_DIR/private.key"
