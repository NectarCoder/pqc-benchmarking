...
export TIMING_RESULTS_DIR=results/qruov5q7L10v1490m190_times
export MEMORY_RESULTS_DIR=results/qruov5q7L10v1490m190_memory
export GENERATED_DIR=results/qruov5q7L10v1490m190_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov5q7L10v1490m190 -out $GENERATED_DIR/private.key"
