...
export TIMING_RESULTS_DIR=results/perk192short3_times
export MEMORY_RESULTS_DIR=results/perk192short3_memory
export GENERATED_DIR=results/perk192short3_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm perk192short3 -out $GENERATED_DIR/private.key"
