...
export TIMING_RESULTS_DIR=results/perkaesaes3short_times
export MEMORY_RESULTS_DIR=results/perkaesaes3short_memory
export GENERATED_DIR=results/perkaesaes3short_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm perkaesaes3short -out $GENERATED_DIR/private.key"
