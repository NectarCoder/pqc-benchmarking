...
export TIMING_RESULTS_DIR=results/perkaesaes5short_times
export MEMORY_RESULTS_DIR=results/perkaesaes5short_memory
export GENERATED_DIR=results/perkaesaes5short_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm perkaesaes5short -out $GENERATED_DIR/private.key"
