...
export TIMING_RESULTS_DIR=results/less25268_times
export MEMORY_RESULTS_DIR=results/less25268_memory
export GENERATED_DIR=results/less25268_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm less25268 -out $GENERATED_DIR/private.key"
