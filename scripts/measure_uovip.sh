...
export TIMING_RESULTS_DIR=results/uovip_times
export MEMORY_RESULTS_DIR=results/uovip_memory
export GENERATED_DIR=results/uovip_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm OV_Ip -out $GENERATED_DIR/private.key"
