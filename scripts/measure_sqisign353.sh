...
export TIMING_RESULTS_DIR=results/sqisign353_times
export MEMORY_RESULTS_DIR=results/sqisign353_memory
export GENERATED_DIR=results/sqisign353_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm sqisign353 -out $GENERATED_DIR/private.key"
