...
export TIMING_RESULTS_DIR=results/perkkeccakkeccak1short_times
export MEMORY_RESULTS_DIR=results/perkkeccakkeccak1short_memory
export GENERATED_DIR=results/perkkeccakkeccak1short_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm perkkeccakkeccak1short -out $GENERATED_DIR/private.key"
