...
export TIMING_RESULTS_DIR=results/uovis_times
export MEMORY_RESULTS_DIR=results/uovis_memory
export GENERATED_DIR=results/uovis_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm OV_Is -out $GENERATED_DIR/private.key"
