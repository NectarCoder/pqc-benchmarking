...
export TIMING_RESULTS_DIR=results/qruov3q31L3v246m87_times
export MEMORY_RESULTS_DIR=results/qruov3q31L3v246m87_memory
export GENERATED_DIR=results/qruov3q31L3v246m87_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov3q31L3v246m87 -out $GENERATED_DIR/private.key"
