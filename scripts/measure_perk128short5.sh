...
export TIMING_RESULTS_DIR=results/perk128short5_times
export MEMORY_RESULTS_DIR=results/perk128short5_memory
export GENERATED_DIR=results/perk128short5_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm perk128short5 -out $GENERATED_DIR/private.key"
