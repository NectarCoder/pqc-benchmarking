...
export TIMING_RESULTS_DIR=results/crossrsdpg3s_times
export MEMORY_RESULTS_DIR=results/crossrsdpg3s_memory
export GENERATED_DIR=results/crossrsdpg3s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm CROSSrsdpg192small -out $GENERATED_DIR/private.key"
