...
export TIMING_RESULTS_DIR=results/qruov3q127L3v228m78_times
export MEMORY_RESULTS_DIR=results/qruov3q127L3v228m78_memory
export GENERATED_DIR=results/qruov3q127L3v228m78_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov3q127L3v228m78 -out $GENERATED_DIR/private.key"
