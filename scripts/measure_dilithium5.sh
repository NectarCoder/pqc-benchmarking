...
export TIMING_RESULTS_DIR=results/dilithium5_times
export MEMORY_RESULTS_DIR=results/dilithium5_memory
export GENERATED_DIR=results/dilithium5_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL
export GEN_CMD="./openssl genpkey -algorithm mldsa87 -out $GENERATED_DIR/private.key"
