...
export TIMING_RESULTS_DIR=results/less400220_times
export MEMORY_RESULTS_DIR=results/less400220_memory
export GENERATED_DIR=results/less400220_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm less400220 -out $GENERATED_DIR/private.key"
