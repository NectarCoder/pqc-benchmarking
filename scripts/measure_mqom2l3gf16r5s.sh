...
export TIMING_RESULTS_DIR=results/mqom2l3gf16r5s_times
export MEMORY_RESULTS_DIR=results/mqom2l3gf16r5s_memory
export GENERATED_DIR=results/mqom2l3gf16r5s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm mqom2cat3gf16shortr5 -out $GENERATED_DIR/private.key"
