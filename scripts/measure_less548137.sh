...
export TIMING_RESULTS_DIR=results/less548137_times
export MEMORY_RESULTS_DIR=results/less548137_memory
export GENERATED_DIR=results/less548137_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm less548137 -out $GENERATED_DIR/private.key"
