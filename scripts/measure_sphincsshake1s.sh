...
export TIMING_RESULTS_DIR=results/sphincsshake1s_times
export MEMORY_RESULTS_DIR=results/sphincsshake1s_memory
export GENERATED_DIR=results/sphincsshake1s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL
export GEN_CMD="./openssl genpkey -algorithm slh-dsa-shake-128s -out $GENERATED_DIR/private.key"
