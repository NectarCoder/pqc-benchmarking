...
export TIMING_RESULTS_DIR=results/sphincssha1f_times
export MEMORY_RESULTS_DIR=results/sphincssha1f_memory
export GENERATED_DIR=results/sphincssha1f_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL
export GEN_CMD="./openssl genpkey -algorithm slh-dsa-sha2-128f -out $GENERATED_DIR/private.key"
