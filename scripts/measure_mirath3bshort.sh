...
export TIMING_RESULTS_DIR=results/mirath3bshort_times
export MEMORY_RESULTS_DIR=results/mirath3bshort_memory
export GENERATED_DIR=results/mirath3bshort_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm mirathtcith3bshort -out $GENERATED_DIR/private.key"
