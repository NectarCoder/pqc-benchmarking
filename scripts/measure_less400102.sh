...
export TIMING_RESULTS_DIR=results/less400102_times
export MEMORY_RESULTS_DIR=results/less400102_memory
export GENERATED_DIR=results/less400102_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm less400102 -out $GENERATED_DIR/private.key"
