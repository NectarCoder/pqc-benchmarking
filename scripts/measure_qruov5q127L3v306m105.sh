...
export TIMING_RESULTS_DIR=results/qruov5q127L3v306m105_times
export MEMORY_RESULTS_DIR=results/qruov5q127L3v306m105_memory
export GENERATED_DIR=results/qruov5q127L3v306m105_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov5q127L3v306m105 -out $GENERATED_DIR/private.key"
