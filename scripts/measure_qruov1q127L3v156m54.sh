...
export TIMING_RESULTS_DIR=results/qruov1q127L3v156m54_times
export MEMORY_RESULTS_DIR=results/qruov1q127L3v156m54_memory
export GENERATED_DIR=results/qruov1q127L3v156m54_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov1q127L3v156m54 -out $GENERATED_DIR/private.key"
