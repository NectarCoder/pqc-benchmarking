...
export TIMING_RESULTS_DIR=results/mqom2l3gf2r5s_times
export MEMORY_RESULTS_DIR=results/mqom2l3gf2r5s_memory
export GENERATED_DIR=results/mqom2l3gf2r5s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm mqom2cat3gf2shortr5 -out $GENERATED_DIR/private.key"
