...
export TIMING_RESULTS_DIR=results/sphincssha3s_times
export MEMORY_RESULTS_DIR=results/sphincssha3s_memory
export GENERATED_DIR=results/sphincssha3s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL
export GEN_CMD="./openssl genpkey -algorithm slh-dsa-sha2-192s -out $GENERATED_DIR/private.key"
