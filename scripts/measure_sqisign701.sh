...
export TIMING_RESULTS_DIR=results/sqisign701_times
export MEMORY_RESULTS_DIR=results/sqisign701_memory
export GENERATED_DIR=results/sqisign701_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm sqisign701 -out $GENERATED_DIR/private.key"
