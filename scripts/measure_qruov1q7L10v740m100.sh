...
export TIMING_RESULTS_DIR=results/qruov1q7L10v740m100_times
export MEMORY_RESULTS_DIR=results/qruov1q7L10v740m100_memory
export GENERATED_DIR=results/qruov1q7L10v740m100_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm qruov1q7L10v740m100 -out $GENERATED_DIR/private.key"
