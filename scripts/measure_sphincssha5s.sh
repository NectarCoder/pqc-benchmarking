...
export TIMING_RESULTS_DIR=results/sphincssha5s_times
export MEMORY_RESULTS_DIR=results/sphincssha5s_memory
export GENERATED_DIR=results/sphincssha5s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL
export GEN_CMD="./openssl genpkey -algorithm slh-dsa-sha2-256s -out $GENERATED_DIR/private.key"
