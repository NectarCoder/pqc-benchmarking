...
export TIMING_RESULTS_DIR=results/snova2965_times
export MEMORY_RESULTS_DIR=results/snova2965_memory
export GENERATED_DIR=results/snova2965_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm snova2965 -out $GENERATED_DIR/private.key"
