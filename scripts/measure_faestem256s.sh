...
export TIMING_RESULTS_DIR=results/faestem256s_times
export MEMORY_RESULTS_DIR=results/faestem256s_memory
export GENERATED_DIR=results/faestem256s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm faestem256s -out $GENERATED_DIR/private.key"
