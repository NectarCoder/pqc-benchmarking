...
export TIMING_RESULTS_DIR=results/hawk512_times
export MEMORY_RESULTS_DIR=results/hawk512_memory
export GENERATED_DIR=results/hawk512_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm hawk512 -out $GENERATED_DIR/private.key"
