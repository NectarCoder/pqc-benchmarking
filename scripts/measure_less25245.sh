...
export TIMING_RESULTS_DIR=results/less25245_times
export MEMORY_RESULTS_DIR=results/less25245_memory
export GENERATED_DIR=results/less25245_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm less25245 -out $GENERATED_DIR/private.key"
