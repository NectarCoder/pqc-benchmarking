...
export TIMING_RESULTS_DIR=results/snova66153_times
export MEMORY_RESULTS_DIR=results/snova66153_memory
export GENERATED_DIR=results/snova66153_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm snova66153 -out $GENERATED_DIR/private.key"
