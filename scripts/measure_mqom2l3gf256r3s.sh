...
export TIMING_RESULTS_DIR=results/mqom2l3gf256r3s_times
export MEMORY_RESULTS_DIR=results/mqom2l3gf256r3s_memory
export GENERATED_DIR=results/mqom2l3gf256r3s_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm mqom2cat3gf256shortr3 -out $GENERATED_DIR/private.key"
