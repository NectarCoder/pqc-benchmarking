...
export TIMING_RESULTS_DIR=results/uovv_times
export MEMORY_RESULTS_DIR=results/uovv_memory
export GENERATED_DIR=results/uovv_generated

# Commands used to generate keys, CSRs, and certificates using OpenSSL via oqs-provider
export GEN_CMD="./openssl genpkey -provider default -provider oqsprovider -algorithm OV_V -out $GENERATED_DIR/private.key"
