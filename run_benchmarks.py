...
if __name__ == "__main__":
    ...
    run_benchmark(out_csv, 'snova2454', ['snova2454','SNOVA 2454','1','1089','1035','248'])
    run_benchmark(out_csv, 'snova37172', ['snova37172','SNOVA 37172','1','9915','9861','124'])
    run_benchmark(out_csv, 'snova2583', ['snova2583','SNOVA 2583','3','2393','2339','165'])
    run_benchmark(out_csv, 'snova56252', ['snova56252','SNOVA 56252','3','31339','31285','178'])
    run_benchmark(out_csv, 'snova2455', ['snova2455','SNOVA 2455','3','1652','1598','379'])
    run_benchmark(out_csv, 'snova49113', ['snova49113','SNOVA 49113','5','6079','6025','286'])
    run_benchmark(out_csv, 'snova3784', ['snova3784','SNOVA 3784','5','4185','4131','376'])
    run_benchmark(out_csv, 'snova60104', ['snova60104','SNOVA 60104','5','8089','8035','576'])
    run_benchmark(out_csv, 'snova2965', ['snova2965','SNOVA 2965','5','2789','2735','454'])
