...
if __name__ == "__main__":
    ...
    # run_benchmark(out_csv, 'snova2454', ['snova2454','SNOVA_24_5_4','1','48','1016','248'])
    # run_benchmark(out_csv, 'snova37172', ['snova37172','SNOVA_37_17_2','1','48','9842','124'])
    # run_benchmark(out_csv, 'snova2583', ['snova2583','SNOVA_25_8_3','1','48','2320','165'])
    # run_benchmark(out_csv, 'snova56252', ['snova56252','SNOVA_56_25_2','3','48','31266','178'])
    # run_benchmark(out_csv, 'snova49113', ['snova49113','SNOVA_49_11_3','3','48','6006','286'])
    # run_benchmark(out_csv, 'snova3784', ['snova3784','SNOVA_37_8_4','3','48','4112','376'])
    # run_benchmark(out_csv, 'snova2455', ['snova2455','SNOVA_24_5_5','3','48','1579','379'])
    # run_benchmark(out_csv, 'snova60104', ['snova60104','SNOVA_60_10_4','5','48','8016','576'])
    # run_benchmark(out_csv, 'snova2965', ['snova2965','SNOVA_29_6_5','5','48','2716','454'])
